...
This repository contains code to search for relevant "documents" from the [MS-Marco Dataset](https://huggingface.co/datasets/mteb/msmarco-v2) given a query.

We use a pre-trained [BERT encoder](https://arxiv.org/pdf/1810.04805) to generate embeddings for queries and documents.
